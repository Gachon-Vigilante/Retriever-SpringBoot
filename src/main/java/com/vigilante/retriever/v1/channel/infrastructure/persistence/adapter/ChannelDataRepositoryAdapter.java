...
import com.vigilante.retriever.v1.channel.infrastructure.mapper.ChannelDataPersistenceMapper;
import com.vigilante.retriever.v1.channel.infrastructure.persistence.document.ChannelDataDocument;
import com.vigilante.retriever.v1.channel.infrastructure.persistence.repository.ChannelDataMongoRepository;

import lombok.RequiredArgsConstructor;

@Repository
@RequiredArgsConstructor
public class ChannelDataRepositoryAdapter implements ChannelDataPersistencePort {

	private final ChannelDataMongoRepository channelDataMongoRepository;
	private final ChannelDataPersistenceMapper channelDataPersistenceMapper;
